...
const TodoForm = () => {
  const { list, add, complete, remove, read } = useListStore();
    ...
    <>
        ...
        return (
          <div className="group" key={id}>
            <label className="flex items-center h-10 px-2 rounded cursor-pointer hover:bg-gray-900">
              ...
              <span
                className="peer-checked:text-gray-500 peer-checked:line-through select-none mx-4 text-sm w-full"
                name="viewer"
              >
                {todo}
              </span>
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="flex items-center w-full mt-2">
          ...
          {/* todo input[s] */}
          <input
            className="flex-grow h-8 ml-4 bg-transparent focus:outline-none font-medium peer/todo"
            type="text"
            id="todo"
            name="todo"
            required
